...
profileControllers.config(['$translatePartialLoaderProvider', function($translatePartialLoaderProvider) {
    $translatePartialLoaderProvider.addPart('profile');
}]);

profileControllers.controller('ProfileGeneralCtrl', 
['$rootScope', '$scope', '$q', '$stateParams', '$route', '$translatePartialLoader', '$translate', 'Users', 'UserAchievements', 'objArr',
function ($rootScope, $scope, $q, $stateParams, $route, $translatePartialLoader, $translate, Users,  UserAchievements, objArr) {
...
['$rootScope', '$scope', '$q', '$stateParams', '$route', '$translatePartialLoader', '$translate', 'Users', 'Statistics',
function ($rootScope, $scope, $q, $stateParams, $route, $translatePartialLoader, $translate, Users, Statistics) {
...
['$rootScope', '$scope', '$q', '$stateParams', '$route', '$translatePartialLoader', '$ionicScrollDelegate',  '$translate', 'Users', 'UserAchievements', 'History', 'objArr',
function ($rootScope, $scope, $q, $stateParams, $route, $translatePartialLoader, $ionicScrollDelegate, $translate, Users,  UserAchievements, History, objArr) {
    ...
    $scope.loadMore = function() {
        ...
        $scope.startDate = moment($scope.startDate).subtract(30, 'days');
