...
// credit Erik MГ¶ller and http://www.paulirish.com/2011/requestanimationframe-for-smart-animating/
'use strict';
...
angular.module('angular-svg-round-progress').service('roundProgressService', [function(){
    ...
    service.animations = {
        ...
        // t: is the current time (or position) of the tween. This can be seconds or frames, steps, seconds, ms, whatever вЂ“ as long as the unit is the same as is used for the total time.
